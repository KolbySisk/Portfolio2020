    ...
    <>
      ...
      <DoubleColumn>
        <Animator containerType={ContainerType.ContentSquare} backgroundColor={work.color}>
          ...
          <p>
            ...
            their multimedia content. With a 2 person team we built a Netflix style web app. My role
            on this project was the front-end dev. I used React and Redux to build the front-end. I
            also created API endpoints using .NET Core.
          </p>
        </Animator>
        <Animator containerType={ContainerType.ImageSquare}>
          {/* <picture>
      ...
      <DoubleColumn>
        <Animator containerType={ContainerType.ContentSquare} backgroundColor={work.color}>
          ...
          <p>
            ...
            developed the app using Ionic and then went through the publishing process for the Apple
            App Store, Google Play store, and Windows App store.
          </p>
        </Animator>
        <Animator containerType={ContainerType.ImageSquare}>
          {/* <picture>
        ...
        <Animator containerType={ContainerType.ContentSquare} backgroundColor={Color.silver}>
          <FontColor color={Color.darkGray}>
            ...
            <p>
              ...
              restaurants as a basic credential for their management staff. The goal was to create a
              web app using Kentico that would help restaurants get certified. I was tasked with the
              front-end and Kentico development.
            </p>
          </FontColor>
        </Animator>
        <Animator containerType={ContainerType.ImageSquare}>
      ...
      <DoubleColumn>
        <Animator containerType={ContainerType.ContentSquare} backgroundColor={work.color}>
          ...
          <p>
            Every year the National Restaurant Association has a conference that features more than
            40,000 restaurant industry executives. The goal was to create a web app using Kentico
            and Angular to help manage and display all of the conference data. I was tasked with the
            front-end development, Kentico development, and creating an API using ASP.NET.
          </p>
        </Animator>
        <Animator containerType={ContainerType.ImageSquare}>
          {/* <picture>
